...
## User:
* A database user is a database-level security principal. It can map to a server login, or it can be a contained database user that does not require a server-level login.
